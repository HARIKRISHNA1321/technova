    ...
    async def event_generator():
        if req.message == "load_basic_policies_rag":
            ...
            prompt = (
                ...
                f"Your answer must be direct, concise, and specifically address only what the user is asking. Do not summarize or list unrelated parts. For specific questions (e.g., 'who is the chairperson of cse dpt?'), provide a direct, concise answer (e.g., 'Mr XYZ is the chairperson of the PESU CSE department and his contact info is example@gmail.com') without unnecessary lists, headers, or details.\n"
